...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Prezzo prodotto con iva:" + String.format("%.2f",videogioco.getPriceIva()) + " " + "euro");
        ...
        System.out.println("Prezzo prodotto con iva:" + String.format("%.2f", console.getPriceIva()) + " " + "euro");
    }
}
